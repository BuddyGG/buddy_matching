defmodule LolBuddyWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule LolBuddy.MyChannel do
        use LolBuddyWeb, :channel
        alias LolBuddy.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :lol_buddy,
                        pubsub_server: LolBuddy.PubSub
end
