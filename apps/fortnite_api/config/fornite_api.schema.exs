...
[
  ...
  import: [],
  mappings: [
    "fortnite_api.fortnite_api_key_client": [
      commented: false,
      datatype: :binary,
      doc: "Provide documentation for fortnite_api.fortnite_api_key_client.",
      hidden: false,
      to: "fortnite_api.fortnite_api_key_client"
    ],
    "fortnite_api.fortnite_api_key_launcher": [
      commented: false,
      datatype: :binary,
